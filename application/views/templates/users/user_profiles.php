                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    ...
                                    <p class="text-muted"><?php echo $profiles[0]['education']; ?></p>
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <p class="text-muted"><?php echo $profiles[0]['skills']; ?></p>
                                </li>
                                <li class="list-group-item">
                                    <strong><i class="fas fa-file-alt mr-1"></i> CV</strong>
                                    <p class="text-muted">
                                        <?php if (!empty($profiles[0]['cv'])): ?>
                                            <a href="<?= base_url('assets/cv/' . $profiles[0]['cv']); ?>" target="_blank" style="color:#222831;!important" class="genric-btn info">View CV</a>
                                        <?php else: ?>
                            ...
                            <?php foreach ($profiles as $profile): ?>
                                <a href="<?php echo site_url('home/editProfile/' . $profile['uId']); ?>" class="btn btn-primary btn-block">Edit</a>
                            <?php endforeach; ?>
                        </div>
                        <!-- /.card-body -->
                    </div>
